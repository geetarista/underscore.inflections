...
(function() {
  ...
  Inflections = (function() {
    ...
    Inflections.prototype.pluralize = function(word, count, plural) {
      if (count !== void 0) {
        return ("" + (count != null ? count : 0) + " ") + (count === 1 || (count != null ? typeof count.toString === "function" ? count.toString().match(/^1(\.0+)?$/) : void 0 : void 0) ? word : plural != null ? plural : this.pluralize(word));
      } else {
